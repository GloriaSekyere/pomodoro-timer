...
const Controls = () => {
  return (
    ...
    md:justify-between md:flex-row md:w-custom26 lg:w-custom28">
      ...
      border-solid border-1 border-green-400
      ...
      <button 
      className="bg-red-200 hover:bg-red-300 h-14 text-white font-bold relative
      border-solid border-1 border-red-400
      ...
      <button 
      className="bg-gray-200 hover:bg-gray-400 h-14 text-black font-bold relative
